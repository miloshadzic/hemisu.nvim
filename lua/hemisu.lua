...
Group.new('String', c.light_tan, nil, no)
Group.new('Constant', c.middle_light_blue, nil, no)
Group.new('Type', c.light_grey, nil, b)
Group.new('Keyword', c.light_green, nil, no)
Group.new('Repeat', g.keyword, nil, no)
Group.new('Function', c.almost_white, nil, no)
Group.new('Todo', c.middle_dark_pink, nil, no)
Group.new('Include', c.almost_white, nil, no)
...
Group.new('TSVariableBuiltin', c.light_grey, nil, no)
...
Group.new('@type.builtin.go', g.Type, nil, i)
Group.new('@module.go', g.Type, nil, no)
Group.new('@type.go', g.Type, nil, b - s.italic)
Group.new('@function.builtin.go', c.light_blue, nil, no)
...
Group.new('DiagnosticDefaultInformation',     c.hue_1,   c.none,  no)
Group.new('DiagnosticDefaultHint',            c.hue_4,   c.none,  no)
Group.new('DiagnosticVirtualTextError',       c.middle_light_pink,   c.none,  no)
Group.new('DiagnosticVirtualTextWarning',     c.light_tan, c.none,  no)
Group.new('DiagnosticVirtualTextInfo', c.middle_light_grey,   c.none,  no)
Group.new('DiagnosticVirtualTextHint',        c.middle_light_grey,   c.none,  no)
...
Group.new('LspDiagnosticsUnderlineInformation',   c.middle_light_grey,  c.none,  ul)
Group.new('LspDiagnosticsUnderlineHint',          c.middle_light_green, c.none,  ul)
Group.new('DiagnosticUnderlineError',         c.middle_light_pink,   c.none,  ul)
Group.new('DiagnosticUnderlineWarning',       c.light_tan,  c.none,  ul)
Group.new('DiagnosticUnderlineInformation',   c.middle_light_grey,  c.none,  ul)
Group.new('DiagnosticUnderlineInfo',   c.middle_light_grey,  c.none,  ul)
Group.new('DiagnosticUnderlineHint',          c.middle_light_green, c.none,  ul)
